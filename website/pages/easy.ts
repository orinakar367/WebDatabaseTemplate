...
var images6to10Div = get("div", "images6-10");
...
for (let a = 6; a < 10; a++) {
    let cardImg2 = create("img", {
        className: "cardImg2",
        src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRlXY0YRlBOQZUyNw3Rz49lQSWrIVPkmmTcPg&s"
    });

    cardImg2.onclick = function () {
        cardImg2.src = "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/01_of_spades_A.svg/960px-01_of_spades_A.svg.png";
    }

    images6to10Div.append(cardImg2);
}
